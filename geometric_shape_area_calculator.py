...
def main():
    ...
    print(str(Circle) + " " + str(Rectangle) + " " + str(Triangle))
    ...
    if choice == 1:  #DO NOT REMOVE THE 'IF'
        ...
        radius = input("What is the raduis of the circle?")
        ...
        area = length * width
        print(f"The area of a the rectangle is: {area}")
    ...
    print("I followed the instructions as advised using everything I learned. Didn't have enough to finish up this laundry list, sorry!")
